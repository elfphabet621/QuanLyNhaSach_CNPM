...
| ---------------- | -------- |---------------------------------- | --------------------------------------------------------------------- |
| register         | guest    | Đăng kí                           | - Cho phép guest tạo tài khoản mới <br> -Kiểm tra input không hợp lệ  |
| login            | guest    | Đăng nhập                         | - Cho phép người dùng đăng nhập vào tài khoản cá nhân (tài khoản đã đăng ký) và tìm role user để redirect đến page đúng với role  |
...
| Báo cáo tồn      | thủ kho  | Xem báo cáo tồn theo tháng                 | - Xem báo cáo tồn theo tháng-năm gồm: tồn đầu, phát sinh, tồn cuối   |
| Báo cáo nợ       | thủ kho  | Xem báo cáo nợ theo tháng                 | - Xem báo cáo nợ theo tháng-năm gồm: nợ đầu, phát sinh, nợ cuối       |

---
# Future work
- Thêm chức năng lựa chọn và tìm kiếm sách bằng thể loại <br>
- Thêm Rest API thay vì sử dụng vanilla javascript  
- Thêm API cho thanh toán thẻ ngân hàng
